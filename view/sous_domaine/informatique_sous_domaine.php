...
<head>
  ...
  <title>CrewConnect - Informatique</title>
...
<body>
  ...
  <div class="overlay">
    ...
    <h2>Dans quoi excellez vous dans l' <?php  echo $domain?> ? </h2>
        <form action="../controler/display_accueil.php" method="post">
        <div class="checkbox-wrapper-16-container">
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" id ="category" name="category" value="Informatique">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Développeur</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Informatique" nombre-colonnes="1">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Administrateur systèmes réseaux</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Informatique">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Analyste cybersécurité</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Informatique">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Data Scientist</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Informatique">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Chef de projet informatique</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Informatique">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Technicien support informatique</span>
                    </span>
                </label>
            </div>
            <!-- Option : Autres -->
