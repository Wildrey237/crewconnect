        ...
        <div class="checkbox-wrapper-16-container">
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    ...
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Développeur/Développeuse</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    ...
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Administrateur/Administratrice systèmes et réseaux</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
            ...
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Lecture">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Technicien/Technicienne support informatique</span>
                    </span>
                </label>
            </div>
