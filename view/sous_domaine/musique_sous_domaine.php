            ...
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    ...
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Chanteur/Chanteuse</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    ...
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Musicien/Instrumentiste</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    ...
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Compositeur/Compositeuse</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    ...
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Producteur/Ingénieur du son</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
