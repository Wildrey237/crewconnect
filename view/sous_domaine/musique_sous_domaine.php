...
<head>
  ...
  <title>CrewConnect - Musique</title>
            ...
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    ...
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Chanteur</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Musique" nombre-colonnes="1">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Musicien</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Musique">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Compositeur</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Musique">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Ingénieur du son</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Musique">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">DJ</span>
                    </span>
                </label>
            </div>
            <div class="checkbox-wrapper-16">
                <label class="checkbox-wrapper">
                    <input class="checkbox-input" type="radio" name="category" id ="category" value="Musique">
                    <span class="checkbox-tile">
                        <span class="checkbox-label">Critique musical</span>
                    </span>
                </label>
            </div>
            <!-- Option : Autres -->
